...
describe('US0001 - Funcionalidade: Login', () => {
  ...
  it('Deve fazer login com sucesso', () => {
      cy.login('claudimedrado@gmail.com', 'teste@123')
      cy.get('[data-test="dashboard-welcome"]').should('contain', 'Bem-vindo Claudia Medrado')
  });

  it('Validar mensagem de erro quando inserir usuário ou senha inválidos', () => {
      cy.login('claumedrado@gmail.com', 'testefddfd@123')
